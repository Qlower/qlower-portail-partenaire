...
export default function PartnersTab() {
  ...
  // Note: l'attribution UTM (sync enum + reconcile orphelins) est gérée
  // automatiquement par le cron toutes les 15 min — pas de bouton manuel.
  // Endpoints d'admin conservés pour debug : /api/admin/sync-hubspot-enum
